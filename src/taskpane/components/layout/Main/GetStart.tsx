...
if(storeToken){
  ...
  //   //client azure
  //   // var a = "https://login.microsoftonline.com/common/oauth2/v2.0/authorize?client_id=8a59fa27-967f-4bcf-ab82-e89c82fa0fa5&response_type=token&redirect_uri=https://shahzadumar-w.github.io/OutlookAddin_AttachmentSorter/assets/Dialog.html&scope=mail.send+Files.ReadWrite.All+openid+profile+email&response_mode=fragment";
