...
module.exports = async (env, options) => {
  ...
  const config = {
    ...
    entry: {
      ...
      ReactDialog: ["./src/taskpane/Dialoges/ReactDialog.tsx", "./src/taskpane/Dialoges/ReactDialog.html"],
    ...
    plugins: [
      ...
      new HtmlWebpackPlugin({
        filename: "ReactDialog.html",
        template: "./src/taskpane/Dialoges/ReactDialog.html",
        chunks: ["polyfill", "vendor", "ReactDialog"],
      }),
